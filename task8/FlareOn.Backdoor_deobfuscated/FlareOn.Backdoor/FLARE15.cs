...
namespace FlareOn.Backdoor
{
	...
	public static class FLARE15
	{
		...
		{
			return FLARE15.flare_63(v, FLARE03.chars_counter);
		}
		...
		{
			return BitConverter.ToInt32(FLARE15.flare_64(v), 0);
		}
		...
		public static object flare_67(byte[] b, int tk, object[] o)
		{
			...
			try
			{
				result = FLARE15.flared_67(b, tk, o);
			}
			catch (InvalidProgramException e)
			{
				result = FLARE15.flare_71(e, new object[]
				{
					b,
					tk,
					o
